package com.pirumart.fontawesome;
...
public class FontDrawable extends Drawable {
    ...
    private void init(Context context, int faIconRes, boolean isSolid, boolean isBrand) {
        ...
        Typeface tf = null;
        if (isSolid) {
            tf = com.pirumart.fontawesome.FontCache.get(context, com.pirumart.fontawesome.FontCache.FA_FONT_SOLID);
        } else if (isBrand) {
            tf = com.pirumart.fontawesome.FontCache.get(context, com.pirumart.fontawesome.FontCache.FA_FONT_BRANDS);
        } else {
            tf = com.pirumart.fontawesome.FontCache.get(context, com.pirumart.fontawesome.FontCache.FA_FONT_REGULAR);
        }
